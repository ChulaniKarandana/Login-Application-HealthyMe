...
public class MainReminderActivity extends AppCompatActivity {
    ...
    public void addReminder(){
        ...
        dialog = new Dialog(MainReminderActivity.this);
        dialog.setContentView(R.layout.reminder_floating_popup);
        ...
        select.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatePickerDialog dialog = new DatePickerDialog(MainReminderActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, final int year, final int month, final int dayOfMonth) {

                        final Calendar newDate = Calendar.getInstance();
                        Calendar newTime = Calendar.getInstance();
                        TimePickerDialog time = new TimePickerDialog(MainReminderActivity.this, new TimePickerDialog.OnTimeSetListener() {
                            @Override
                            public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                                ...
                                if(newDate.getTimeInMillis()-tem.getTimeInMillis()>0)
                                    ...
                                    Toast.makeText(MainReminderActivity.this,"Invalid time",Toast.LENGTH_SHORT).show();
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MainReminderActivity.this,NotifierAlarm.class);
                ...
                PendingIntent intent1 = PendingIntent.getBroadcast(MainReminderActivity.this,reminders.getId(),intent,PendingIntent.FLAG_UPDATE_CURRENT);
                AlarmManager alarmManager = (AlarmManager)getSystemService(ALARM_SERVICE);
                alarmManager.setExact(AlarmManager.RTC_WAKEUP,calendar.getTimeInMillis(),intent1);

                Toast.makeText(MainReminderActivity.this,"Inserted Successfully",Toast.LENGTH_SHORT).show();
                setItemsInRecyclerView();
